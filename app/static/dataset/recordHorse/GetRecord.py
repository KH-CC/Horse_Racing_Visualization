...
all_record['Rtg'] = all_record['Rtg'].apply(lambda x: 100 if x == 999 else x)
all_record['FinishTime'] = all_record['FinishTime'].apply(lambda x: "1.46.36" if x == "0.00.00" else x)
